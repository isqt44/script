...
echo -           MENU             -
echo ------------------------------
echo - 1) Receive Buffers "512"   -
echo - 2) Receive Buffers "1024"  -
echo - 3) Receive Buffers "2048"  -
echo - 4) Receive Buffers "4096"  -
...
if %rb% EQU 1 (
    ...
    set /p "x=Introduce the new value for Receive Buffers: "
) else (
    echo Invalid option
    exit /b
)
